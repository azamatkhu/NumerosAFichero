...
Primero, he creado las clases CreadorFichero, que sirve para crear el fichero. En ello aplico la logica de creacion de lineas con los numeros.
...
Otro clase GeneradorNumeros me sirve para generar los numeros pidiendo al usuario. No es algo especial, es solo un ArrayList de tipo Integer, en que con un bucle for guardo los numeros.
